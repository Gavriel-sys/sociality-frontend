...
function RegisterContent() {
  ...
  return (
    <div className="fixed inset-0 overflow-y-auto bg-black">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(99,56,255,0.45),transparent_24%),radial-gradient(circle_at_bottom_left,rgba(147,51,234,0.35),transparent_24%),linear-gradient(to_bottom,#000000,#04020a,#090114)]" />
        ...
        <div className="grid w-full gap-6 lg:grid-cols-[1fr_520px]">
          <div className="hidden rounded-[40px] border border-white/10 bg-white/[0.03] p-10 shadow-[0_24px_80px_rgba(0,0,0,0.35)] backdrop-blur-sm lg:block">
            ...
            <h1 className="mt-4 text-5xl font-semibold tracking-tight text-white">
              Bangun identitas kamu, lalu isi feed dengan cerita yang penting.
            </h1>
            <p className="mt-5 max-w-xl text-base leading-8 text-white/65">
              Setelah daftar, kamu langsung bisa membuat post, mengikuti user lain,
              dan mengelola profile pribadi tanpa perlu setup yang ribet.
            </p>
          </div>
          ...
          <div className="w-full rounded-[36px] border border-white/10 bg-black/45 p-6 shadow-[0_24px_80px_rgba(0,0,0,0.35)] backdrop-blur-md sm:p-8">
            ...
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-white/55">
                Isi data utama dulu, nanti profile lengkap bisa kamu lanjutkan dari halaman me.
              </p>
            </div>
