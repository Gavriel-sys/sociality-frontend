...
function LoginContent() {
  ...
  return (
    <div className="fixed inset-0 overflow-y-auto bg-black">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,rgba(109,40,217,0.85),transparent_34%),radial-gradient(circle_at_bottom_right,rgba(147,51,234,0.72),transparent_38%),linear-gradient(180deg,#000000_0%,#02020b_54%,#130322_100%)]" />

      <div className="relative flex min-h-screen items-center justify-center px-4 py-10">
        <div className="w-full max-w-[400px] rounded-[18px] border border-white/10 bg-black/45 px-6 py-8 shadow-[0_24px_80px_rgba(0,0,0,0.48)] backdrop-blur-md sm:px-8">
